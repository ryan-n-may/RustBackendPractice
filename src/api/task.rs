...
// ResponseError is a trait of the Actix web framework.
impl ResponseError for TaskError {
    /*
        Most fine-grained way to control API response is by using 
        HTTPRESPONSE Object. 
        In API we dont need that control so we return JSON object and 
        allow Actix to convert to HTTPRESPONSE.
    */
